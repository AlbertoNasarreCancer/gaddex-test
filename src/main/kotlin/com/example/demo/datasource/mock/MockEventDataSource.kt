...
class MockEventDataSource : EventDataSource {
    ...
    val events = mutableListOf(
            Event(Id = 1,Title="test",Description = "descriptivism1",Date= LocalDate.parse("2018-12-12"),Location=ArrayList<Double>(2),Image=ByteArray(100)),
            Event(Id = 2,Title = "test2",Description = "descriptivism2",Date= LocalDate.parse("2018-12-12"),Location=ArrayList<Double>(2),Image=ByteArray(100))
    )
